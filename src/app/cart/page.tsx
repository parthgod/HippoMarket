        ...
        <div className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
          <div
            className={cn("lg:col-span-7", {
              "rounded-lg border-2 border-dashed border-zinc-100": isMounted && items.length === 0,
            })}
          >
            ...
            <ul
              className={cn({
                "divide-y divide-gray-200 border-t border-b border-gray-200": isMounted && items.length > 0,
              })}
            >
              {isMounted &&
                items.map(({ product }) => {
