          ...
          <div className="lg:col-start-2">
            ...
            {order._isPaid ? (
              <p className="mt-2 text-base text-muted-foreground">
                Your order was processed and your assets are available for download. We&apos;ve sent your receipt and
                order details to{" "}
              ...
              <p className="mt-2 text-base text-muted-foreground">
                We appreiate your order, and we&apos;re processing it. Hand tight and we&apos;ll send you confirmation
                very soon
              </p>
            )}
